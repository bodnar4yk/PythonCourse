...
#print(f"Data_describe{data.describe()}")
...
######################################################
# alpha=0.05
# train_sample=close_values[:-252]
# VaR=np.percentile(train_sample, alpha*100)
# ES = np.mean(train_sample[train_sample <= VaR])
# print(VaR,ES)

# test_sample=close_values[-252:]
# count = len(test_sample[test_sample <= VaR])
# print(count,len(test_sample))
