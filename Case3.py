    ...
    print(f"{'n':>7} | {'m_hat':>10} | {'Std Error':>10} | {'95% CI':^20} | {'Time (m_hat)':>15}| {'Time (s_n)':>10}")
    print("-" * 80)
    ...
    for n in n_values:
        ...
        if n==n_values[-1]:
            print(f"{n:7d} | {m_hat:10.6f} | {s_n:10.6f} | ({ci[0]:7.6f}, {ci[1]:7.6f}) | {duration_m_hat:15.6f}| {duration_s_n:10.6f}")
        else:
            print(f"{n:7d} | {m_hat:10.6f} | {s_n:10.6f} | ({ci[0]:7.6f}, {ci[1]:7.6f}) | {'-':15.6}| {'-':10.6}")
